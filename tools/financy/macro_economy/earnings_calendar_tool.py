...
class EarningsCalendarTool(BaseTool):
    name: str = "EarningsCalendarTool"
    description: str = (
        "Executes an AI agent to retrieve relevant events from next week's earnings calendar."
    )
    args_schema: Type[BaseModel] = EarningsCalendarToolInput
    ...
    def _run(self) -> str:
            async def main():
                ...
                initial_actions = [
                    {'open_tab': {'url': 'https://tradingeconomics.com/earnings'}}
                ]
